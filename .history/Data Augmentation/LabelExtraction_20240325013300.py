...
def overlay_map_background(tp_image_path='Data Augmentation\\Backgrounds\\BG_TRANSPARENT\\TP_LOTUS.png'):
    # Load the images
    foreground = cv2.imread(tp_image_path, cv2.IMREAD_UNCHANGED)
    background = cv2.imread('Data Augmentation\\LOTUS_frame160.jpg')
