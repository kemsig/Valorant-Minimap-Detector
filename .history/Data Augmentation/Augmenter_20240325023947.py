    ...
    for class_name, int_value in classes.items():
        ...
        for count in range(int_value):
            ...
            def convert_to_yolo_format(x, y, width, height, image_width, image_height):
                ...
                y_norm = ( + image_height/2) / image_height
...
if __name__ == "__main__":
    generate_yolo_batch(count=1, name='test', background_path='Data Augmentation\\Backgrounds', output_path='Data Augmentation\\testset')