...
def generate_data_YOLO(name, main_img_path, out_image_path, out_label_path,
                       bb_variance=True, variance_pixel_range=5, gadgets=True, gadget_count=3, gadget_labeled=False
                    ):
    # open image
    ...
    if gadgets:
        classes = {"max_blue":max_blue,
               ...
               "dead red":dead_red,
               "bomb":bomb,
               "gadget red" : random.randint(0,gadget_count),
               "gadget blue" : random.randint(0,gadget_count)
            }
...
if __name__ == "__main__":
    generate_yolo_batch(count=1000, name='daug_lotus_var5px_gad_nolabel', background_path='Data Augmentation\\Backgrounds', output_path='TrainingSet\\DAUG_GADGET_NOLABEL')