...
def draw_on_image(imagepath):
    ...
    #small_image2 = cv2.imread('Data Augmentation\\test_output\\fade red\\fade red_1f428ac5-4edb-4f80-b73b-ec5471183be1.png', cv2.IMREAD_UNCHANGED)
