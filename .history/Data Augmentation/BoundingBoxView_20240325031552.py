...
def main():
    ...
    image_path = 'model\\yoloset_with_daug_bb5px\\images\\Train\\daug_lotus_bbvar_5px_6.jpg'
    label_file_path = 'model\\yoloset_with_daug_bb5px\\labels\\Train\\daug_lotus_bbvar_5px_6.txt'
